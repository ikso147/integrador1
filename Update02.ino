...
//Pinos Motor 1 (base)
#define DIR_M1_PIN 4
#define STEP_M1_PIN 5
#define EN_M1_PIN 6

//A4988 motor1(DIR_M1_PIN, STEP_M1_PIN, EN_M1_PIN);
...
char readKeypad() {
  ...
  const char keys[numRows][numCols] = {
    { '1', '2', '3', '4', '5' }  //1 - SEL; 2- DEC; 3 - INC; 4 - BEFORE; 5 - NEXT
  };
...
void TimerSelector() {
  ...
  if (key == '1') {
    ...
    int tempoLav = (tempo[0][0]*10+tempo[0][1])*60+tempo[0][2]*10+tempo[0][3];
    int tempoCur = (tempo[1][0]*10+tempo[1][1])*60+tempo[1][2]*10+tempo[1][3];
    int tempoMin = 600;
